...
/*   Updated: 2022/04/04 04:31:31 by gvitor-s         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			exec_builtin_pipeline(struct s_program *current_prog,
				struct s_exec *exc);
...
int			exec_builtin_parent(struct s_program *current_prog,
				struct s_exec *exc);
#endif
